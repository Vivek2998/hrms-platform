...
async function main() {
  ...
  const leaveTypes = [
    ...
    { name: "Earned Leave", code: "EL", daysAllowed: 21, isPaid: true, isCarryForward: true, maxCarryForward: 30, isEncashable: true },
    ...
    { name: "Leave Without Pay", code: "LWP", daysAllowed: 365, isPaid: false, isEncashable: false },
  ];
  ...
  const components = [
    ...
    { name: "LTA", code: "LTA", type: "EARNING", defaultPercent: 10, isTaxable: false, displayOrder: 4 },
    { name: "Medical Allowance", code: "MED_ALLOW", type: "EARNING", isFixedAmount: true, defaultAmount: 1250, isTaxable: false, displayOrder: 5 },
    ...
    { name: "Provident Fund (Employer)", code: "PF_EMP_ER", type: "STATUTORY", isTaxable: false, displayOrder: 20 },
    { name: "ESI (Employer)", code: "ESI_EMP_ER", type: "STATUTORY", isTaxable: false, displayOrder: 21 },
  ];
  ...
  console.log(`✅ Salary components: ${components.length} created`);
